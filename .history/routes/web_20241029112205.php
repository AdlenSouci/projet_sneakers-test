...
Route::get('/filtrer-par-marque', [ShopController::class, 'filtrerParMarque'])->name('filtrer-par-marque');
Route::get('/filtrer-par-prix', [ShopController::class, 'filtrerParPrix'])->name('filtrer-par-prix');
Route::get('/filtrer-par-famille', [ShopController::class, 'filtrerParFamille'])->name('filtrer-par-famille');
Route::get('/filtrer-par-couleur', [ShopController::class, 'filtrerParCouleur'])->name('filtrer-par-couleur');
