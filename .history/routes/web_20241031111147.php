...
//les filtres
Route::get('/shop/filter', 'ShopController@filter')->name('shop.filter');
Route::get('/articles/filter', [App\Http\Controllers\ArticleController::class, 'filter'])->name('articles.filter');
