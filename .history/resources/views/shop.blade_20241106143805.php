<x-app-layout>
    <section class="py-5 custom-section">
        ...
        <div class="container px-4 px-lg-5 mt-5  rounded">
            <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-2 row-cols-xl-4 justify-content-center g-3  rounded">
                <?php foreach ($articlesData as $article) : ?>
                    <?php $stock_article = array_sum(array_column($article->tailles->toArray(), 'stock')); ?>


                    <div class="col mb-5  rounded" data-marque="{{ $article->nom_marque }}" data-couleur="{{ $article->nom_couleur }} ">
