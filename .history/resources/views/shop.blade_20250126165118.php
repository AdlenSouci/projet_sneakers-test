    ...
    <section class="py-5 custom-section">
        ...
        <form id="filterForm" class="d-flex flex-wrap justify-content-center align-items-center">
            <div class="form-group mr-2">
                ...
                <select id="marque" name="marque" class="form-control" style="width: 180px;" onchange="this.form.submit()" >
            ...
            <div class="form-group mr-2">
                ...
                <select id="couleur" name="couleur" class="form-control rounded-pill" style="width: 180px;" onchange="this.form.submit()" >
            ...
            <div class="form-group mr-2 rounded-pill">
                ...
                <select id="prix" name="prix" class="form-control rounded" style="width: 180px;" onchange="this.form.submit()" >
            ...
            <div class="form-group mr-2 rounded" onchange="this.form.submit()">
            ...
            <div class="form-group mr-2" onchange="this.form.submit()">
