...
<div class="row mb-4">
    <div class="col-md-3">
        <select id="marque" class="form-select">
    ...
    <div class="col-md-3">
        <input type="number" id="prixMin" class="form-control" placeholder="Prix min">
    </div>

    <div class="col-md-3">
        <input type="number" id="prixMax" class="form-control" placeholder="Prix max">
    </div>
</div>

<!-- Bouton de filtrage -->
<div class="text-center mb-4">
    <button id="filtrerBtn" class="btn btn-primary">Filtrer</button>
</div>
