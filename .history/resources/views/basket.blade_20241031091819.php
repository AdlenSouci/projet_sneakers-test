<x-app-layout>
    ...
    <script src="{{ asset('js/panier/calculerPrixTotal.js') }}"></script>
    <script src="{{ asset('js/panier/viderPanier.js') }}"></script>
    <script src="{{ asset('js/panier/viderArticlePanier.js') }}"></script>
    <script src="{{ asset('js/panier/changerQuantiter.js') }}"></script>
    <script src="{{ asset('js/panier/passerCommande.js') }}"></script>
