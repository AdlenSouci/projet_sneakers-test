<x-app-layout>
    <section class="py-5 custom-section">
        ...
        <form id="filterForm" class="container px-4 px-lg-5 mt-5" method="GET" action="{{ route('shop.filter') }}">
            <div class="form-group mt-3 ">
                <label for="marque">Marque</label>
                <select id="marque" name="marque" class="form-control mt-3">
            ...
            <div class="form-group mt-3">
                ...
                <select id="couleur" name="couleur" class="form-control mt-3">
    ...
    <script>
        ...
        $(document).ready(function() {
            // Lorsque le formulaire de filtre est soumis
            $('#filterForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Affiche uniquement les articles qui correspondent au filtre
                        response.articlesData.forEach(function(article) {
                            var articleElement = $('.article').filter(function() {
                                return $(this).data('marque') === article.marque && $(this).data('couleur') === article.couleur;
                            });
