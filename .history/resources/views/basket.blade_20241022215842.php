<x-app-layout>
    ...
    <script>
        // Les fonctions JavaScript que tu as fournies précédemment
        ...
        function changerQuantiter(input) {
            ...
            if (!isNaN(newQuantity) && newQuantity > 0) {
                var itemPriceElement = input.closest('.row').querySelector(".text-start strong");
        ...
        function calculerPrixTotal() {
            var itemPrices = document.querySelectorAll('.text-start strong');
