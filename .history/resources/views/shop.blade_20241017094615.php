                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            @if($stock_article > 0)
                                            <a class="btn btn-success text-white mt-2 ajouter_au_panier" role="button" data-article-id="{{ $article['id'] }}">
                                ...
                                <div class="text-center custom-text-center mt-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-3">
                                        <div class="me-3">
                                            ...
                                            <select id="pointure_{{ $article['id'] }}" name="pointure" class="custom-label custom-select rounded" style="width: 80px">
    ...
    <script>
        document.addEventListener('click', function(event) {
            ...
            if (target) {
                ...
                var pointureElement = cardBody ? cardBody.querySelector(`#pointure_${articleId}`) : null; // Utilisation de l'ID unique
                var quantiteElement = cardBody ? cardBody.querySelector('[name="quantite"]') : null; // Éléments de quantité

                // Vérifie si le sélecteur de pointure est bien trouvé
                if (pointureElement && pointureElement.value) {
                    var quantite = quantiteElement ? quantiteElement.value : 1; // Valeur par défaut à 1
