<x-app-layout>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var countElement = document.getElementById('countArticle');
        var count = {{ count(Session::get('cart', [])) }};
        countElement.textContent = count;
    });

    // Update the count of items in the cart after adding an item
