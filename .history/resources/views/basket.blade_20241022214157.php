                                ...
                                @foreach ($cartItems as $item)
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm me-1 mb-2" onclick="viderArticlePanier(this)" data-article-id="{{ $item['id'] }}" title="Remove item">
                                            ...
                                            <div class="d-flex mb-4" style="max-width: 300px">
                                                ...
                                                <div class="form-outline">
                                                    <input type="number" class="form-control" value="{{ $item['quantity'] }}" min="1" onchange="changerQuantiter(this)" data-item-price="{{ $item['price'] }}">
                        ...
                        <div class="card-body">
                            ...
                            @if(auth()->check())
                                <form action="{{ route('passer-commande') }}" method="post" onsubmit="event.preventDefault(); passerCommande();">
                                    @csrf
                                    <input type="text" class="form-control mb-3" name="adresse_livraison" id="adresse_livraison" placeholder="Adresse de livraison" required>
                                    <button type="submit" id="passCommandButton" class="btn btn-primary btn-lg btn-block">Passer la commande</button>
                                </form>
                            @else
