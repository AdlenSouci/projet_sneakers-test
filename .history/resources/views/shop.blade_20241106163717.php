        ...
        <div class="container px-4 px-lg-5 mt-5  ">
            <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-2 row-cols-xl-4 justify-content-center g-3  ">
                <?php foreach ($articlesData as $article) : ?>
                    ...
                    <div class="col-md-4 " data-marque="{{ $article->nom_marque }}" data-couleur="{{ $article->nom_couleur }} ">
                        <!-- Contenu de l'article -->
                        <div class="ccard mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img img-fluid" src="{{ asset('img/' . $article['img']) }}" alt="Product Image" />
                                <div class="card-img-overlay rounded-0 product-overlay  justify-content-center">
