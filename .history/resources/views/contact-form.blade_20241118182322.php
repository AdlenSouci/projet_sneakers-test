    ...
    <div class="container mt-4" style="width:600px">
        <form id="mailForm" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control rounded" id="txtNom" placeholder="Entrez v" required>
            </div>
            <div class="form-group">
                <label for="txtNom">Prenom</label>
                <input type="text" name="username" class="form-control rounded" id="txtPrenom" placeholder="Entrez votre prénom" required>
            </div>
