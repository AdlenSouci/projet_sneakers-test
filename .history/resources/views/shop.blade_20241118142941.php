...
<style>
    .product-wap {
        max-width: 280px; /* Ajustez la largeur selon vos besoins */
        height: auto;
    }
        ...
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-2 row-cols-xl-4 justify-content-center g-3">
                <?php foreach ($articlesData as $article) : ?>
                    ...
                    <div class=" col-md-3 mb-5" data-marque="{{ $article->nom_marque }}" data-couleur="{{ $article->nom_couleur }}" data-prix="{{ $article->prix_public }}">
                        <div class="card mb-4 product-wap rounded-lg card-sm">
