<x-app-layout>
  ...
  <div class="form-group col-md-4 mr-2">
    ...
    <select id="marque" name="marque" class="form-control form-control-lg">
  ...
  <div class="form-group col-md-4 mr-2">
    ...
    <select id="couleur" name="couleur" class="form-control form-control-lg">
  ...
  <div class="form-group col-md-4 mr-2">
    ...
    <select id="prix" name="prix" class="form-control form-control-lg">
  ...
  <div class="form-group col-md-4 mr-2">
    ...
    <input type="number" id="prix_min" name="prix_min" class="form-control form-control-lg" placeholder="Min" min="0">
  </div>

  <div class="form-group col-md-4 mr-2">
    <label for="prix_max" class="mr-2">Prix Max</label>
    <input type="number" id="prix_max" name="prix_max" class="form-control form-control-lg" placeholder="Max" min="0">
  </div>
