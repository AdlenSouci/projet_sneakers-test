    ...
    <section class="py-5 custom-section">
        ...
        <form id="filterForm" class="container px-4 px-lg-5 mt-5">
            <div class="form-group mt-3">
                ...
                <select id="marque" name="marque" class="form-control mt-3" style="width: auto; min-width: 150px; max-width: 150px;">
            ...
            <div class="form-group mt-3">
                ...
                <select id="couleur" name="couleur" class="form-control mt-3" style="width: 150px;">
