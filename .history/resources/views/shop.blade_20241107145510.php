...
<style>
    ...
    #filterForm label {
        margin-right: 5px; /* Moins d'espacement entre l'étiquette et le champ */
    }

    #filterForm .form-control {
        max-width: 180px; /* Largeur ajustée pour éviter les champs trop larges */
    }

    #filterForm button {
        margin-left: 10px; /* Espacement entre le bouton et les champs */
    }
</style>
