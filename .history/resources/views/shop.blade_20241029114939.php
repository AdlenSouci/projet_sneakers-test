<x-app-layout>
    ...
    <!-- Filtre par marque -->
    <form id="filtre-marque" method="GET" action="{{ route('filtrer-par-marque') }}">
    ...
    <!-- Filtre par prix -->
    <form id="filtre-prix" method="GET" action="{{ route('filtrer-par-prix') }}">
    ...
    <!-- Filtre par famille -->
    <form id="filtre-famille" method="GET" action="{{ route('filtrer-par-famille') }}">
        <select name="famille" id="famille">
            @foreach($familles as $famille)
            <option value="{{ $famille }}">{{ $nom_famille }}</option>
            @endforeach
        </select>
        <button type="submit">Filtrer</button>
    </form>
    ...
    <!-- Filtre par couleur -->
    <form id="filtre-couleur" method="GET" action="{{ route('filtrer-par-couleur') }}">
