<x-app-layout>
    <section class="py-5 custom-section">
        ...
        <form id="filterForm" class="d-flex flex-wrap justify-content-center align-items-center rounded">
            <div class="form-group mr-2">
                <label for="marque" class="mr-2 rounded-pill">Marque</label>
            ...
            <div class="form-group mr-2">
                <label for="couleur" class="mr-2 rounded-pill">Couleur</label>
            ...
            <div class="form-group mr-2 rounded">
                <label for="prix" class="mr-2 rounded-pill">Prix</label>
            ...
            <div class="form-group mr-2 rounded">
                <label for="prix_min" class="mr-2 rounded">Prix Min</label>
                <input type="number" id="prix_min" name="prix_min" class="form-control rounded" style="width: 180px;" placeholder="Min" min="0">
            </div>
