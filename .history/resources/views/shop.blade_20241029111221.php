    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action active">Filtres</a>
                <a href="#" class="list-group-item list-group-item-action">Marques</a>
                <a href="#" class="list-group-item list-group-item-action">Couleurs</a>
                <a href="#" class="list-group-item list-group-item-action">Prix</a>
            </div>
        </div>
        <div class="col-md-9">
            <div class="row">
                @foreach ($articlesData as $article)
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top" src="{{ asset('img/' . $article['img']) }}" alt="Product Image">
                            <div class="card-body">
                                <h5 class="card-title">{{ $article['nom_marque'] }} {{ $article['modele'] }}</h5>
