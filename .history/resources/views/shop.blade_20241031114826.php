            ...
            <form id="filterForm">
                <div class="row mb-3">
                    <div class="col">
                        <select name="marque" class="form-select">
                            ...
                            <option value="{{ $marque->id }}" class="text-black">{{ $marque->nom_marque }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <select name="couleur" class="form-select">
                            ...
                            <option value="{{ $couleur->nom }}">{{ $couleur->nom_couleur }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="number" name="prix_min" id="prix_min" class="form-control" placeholder="Prix min">
                    </div>
                    <div class="col">
                        <label for="prix_max">Prix Max:</label>
                        <input type="number" name="prix_max" id="prix_max" class="form-control" placeholder="Prix max">
                    </div>
                </div>
        ...
        $(document).ready(function() {
            $('#filterForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    data: $(this).serialize(),
                    success: function(response) {
                        // Mettez à jour la liste des articles avec les données filtrées
                        let articlesContainer = $('.row.gx-4.gx-lg-5');
                        articlesContainer.empty(); // Effacez les articles précédents

                        // Ajoutez les articles filtrés
