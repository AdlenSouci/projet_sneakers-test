<x-app-layout>
                    ...
                    <div class="col mb-5">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                ...
                                <!--  dans l'image on a le bouton panier pas de choix de pointure et de quantité  -->
    ...
    if (target) {
        ...
        var pointureElement = document.getElementById('pointure'); // Accéder par ID
        var quantiteElement = document.querySelector('[name="quantite"]'); // Accéder par nom
        var quantite = quantiteElement ? quantiteElement.value : null; // Obtenir la valeur
