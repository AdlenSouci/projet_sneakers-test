<x-app-layout>
    <section class="py-5 custom-section">
        <!-- section du filtre de produit par marque, famille et prix-->
                    ...
                    <div class="card h-100">
                        <div class="card-body p-4">
                            <div class="text-center">
                                <h5 class="fw-bolder">Filtrer par :</h5>
                            </div>
                        </div>
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{ route('shop') }}">Tout</a></div>
                        </div>
                    </div>
                </div>
                @foreach ($marques as $marque)
                    <div class="col mb-5">
                        <div class="card h-100">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">{{ $marque->nom_marque }}</h5>
                                </div>
                            </div>
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{ route('marque', $marque->id) }}">Voir tous</a></div>
                            </div>
                        </div>
                    </div>
                @endforeach
