        ...
        <section class="h-100 h-custom">
            <div class="container py-5 h-100">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-lg-7">
                        <div class="card card-registration card-registration-2 shadow-lg border-0" style="border-radius: 15px;">
                            <div class="card-body p-0">
                                <div class="row g-0">
                                    @if (empty($cartItems))
                                    <div class="col mb-5 text-center p-5">
                                        <h1 class="fw-bold mb-0 text-black">Panier</h1>
                                        <div class="text-muted mt-4">Votre panier est vide</div>
                                        <a href="/shop" class="btn btn-outline-primary mt-4">Retour à la boutique</a>
                                    </div>
                                    @else
                                    <div class="col-lg-15">
                                        <div class="p-5">
                                            ...
                                            <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                <div class="col-md-2">
                                                    <img src="{{ asset('/img/' . $item['image']) }}" class="img-fluid rounded shadow-sm" alt="{{ $item['name'] }}">
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <h6 class="mb-0 item-price text-primary">€ {{ number_format($item['price'] * $item['quantity'], 2) }}</h6>
                                                </div>
                                                ...
                                                <div class="col-md-1 text-end">
                                                    <a href="#!" class="text-danger" onclick="viderArticlePanier(this)" data-article-id="{{ $item['id'] }}">
                                            ...
                                            <div class="pt-5">
                                                <button class="btn btn-danger btn-lg w-100 animate-button" onclick="viderPanier()">Vider le panier</button>
                                            </div>
                                        </div>

                                        <div class="col-lg-4 bg-light">
                                            <div class="p-5 shadow rounded">
                                                <h3 class="fw-bold mb-5">Résumé</h3>
                                                <hr class="my-4">
                                                <div class="d-flex justify-content-between mb-5">
                                                    <h5 class="text-uppercase">Total</h5>
                                                    <h5 id="totalPrice" class="text-primary">€ {{ number_format($totalPrice, 2) }}</h5>
                                                </div>
                                                @if(auth()->check())
                                                <form action="{{ route('passer-commande') }}" method="post" onsubmit="event.preventDefault(); passerCommande();">
                                                    ...
                                                    <button type="submit" id="passCommandButton" class="btn btn-dark btn-lg w-100 animate-button">Passer la commande</button>
                                                </form>
                                                @else
