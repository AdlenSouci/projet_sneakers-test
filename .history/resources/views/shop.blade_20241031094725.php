<x-app-layout>
    <section class="py-5 custom-section">
        <!--faire un panier avec un menu deroulant plutot que de faire une page panier-->
        ...
        <div class="d-flex gap-2">
            <select id="filter_marque" class="form-select" aria-label="Filtrer par marque">
            ...
            <select id="filter_famille" class="form-select" aria-label="Filtrer par famille">
            ...
            <input type="text" id="filter_modele" class="form-control" placeholder="Rechercher un modèle">
            <select id="filter_couleur" class="form-select" aria-label="Filtrer par couleur">
            ...
            <select id="filter_prix" class="form-select" aria-label="Filtrer par prix">
...
<script>
        $(document).ready(function() {
            function filtrerArticles() {
                ...
                let marque = $('#filter_marque').val();
                let famille = $('#filter_famille').val();
                let modele = $('#filter_modele').val();
                let couleur = $('#filter_couleur').val();
                let prix = $('#filter_prix').val();

                $.ajax({
                    url: '{{ route("articles.filter") }}', // Assurez-vous que cette route est correcte
                    method: 'GET',
                    data: {
                        marque: marque,
                        famille: famille,
                    ...
                    success: function(response) {
                        // Met à jour la zone des articles
            ...
            // Appel de la fonction filtrerArticles chaque fois qu'un filtre change
            $('#filter_marque, #filter_famille, #filter_modele, #filter_couleur, #filter_prix').on('change keyup', function() {
                filtrerArticles();
            });
        });
    </script>
