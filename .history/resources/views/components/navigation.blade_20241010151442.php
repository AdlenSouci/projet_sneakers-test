<nav x-data="{ open: false }" class="navbar navbar-expand-lg navbar-light shadow bg-light">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <!-- Navigation Links -->
        <div class="collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between" :class="{'show': open}" id="navbarNav">
            <ul class="navbar-nav mx-lg-auto">
                <li class="nav-item">
                    <x-nav-link :href="route('index')" :active="request()->routeIs('index')" class="nav-link">{{ __('Accueil') }}</x-nav-link>
                </li>
                <li class="nav-item">
                    <x-nav-link :href="route('about')" :active="request()->routeIs('about')" class="nav-link">{{ __('À propos') }}</x-nav-link>
                </li>
                <li class="nav-item">
                    <x-nav-link :href="route('shop')" :active="request()->routeIs('shop')" class="nav-link">{{ __('Boutique') }}</x-nav-link>
                </li>
                <li class="nav-item">
                    <x-nav-link :href="route('basket')" :active="request()->routeIs('basket')" class="nav-link">{{ __('Panier') }}</x-nav-link>
                </li>
                <li class="nav-item">
                    <x-nav-link :href="route('contact.form')" :active="request()->routeIs('contact.form')" class="nav-link">{{ __('Contact') }}</x-nav-link>
                </li>
                @guest
                <li class="nav-item">
                    <x-nav-link :href="route('login')" :active="request()->routeIs('login')" class="nav-link">{{ __('Connexion') }}</x-nav-link>
                </li>
                @endguest
            </ul>
