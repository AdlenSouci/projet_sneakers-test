        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- ajout d'un lien vers la vue panier qui affiche automatiquement le nombre de produits dans le panier -->
    ...
    <script>
        ...
        document.addEventListener('livewire:load', function () {
            window.addEventListener('cart:changed', event => {
                document.querySelector('.badge').textContent = event.detail.count;
            });
    </script>
