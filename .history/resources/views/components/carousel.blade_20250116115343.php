            ...
            <div class="carousel-item active">
                <div class="container">
                    ...
                    <div class="col-lg-6 mb-0 d-flex align-items-center">
                            ...
                            <h1 class="h2" style ="color: #de7105;"><b>My sneakers</b>  Shop</h1>
                            <h3 class="h3"> Le site ou vous pouvez acheter la sublime <strong> Air Max x Patta </strong></h3>
                            <p>
                ...
                <div class="row p-5">
                    ...
                    <div class="col-lg-6 mb-0 d-flex align-items-center">
                        <div class="text-align-left">
                            <h1 class="h2">Assics revient avec du très lourd</h1>
                            <h3 class="h3">La qualité au top de gamme</h3>
        ...
        <div class="carousel-item">
            <div class="container">
                <div class="row p-5">
                    ...
                    <div class="col-lg-6 mb-0 d-flex align-items-center">
                        <div class="text-align-left">
                            <h3 class="h3">Une paire rare presque introuvable sauf en occasion mais ici tout est possible</h1>
