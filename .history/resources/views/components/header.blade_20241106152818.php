<header class="py-5 header-custom">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="header-custom display-4 fw-bolder" style="color: #de7105;">My Sneakers</h1>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const texts = [
            ...
            "Nous proposons une large sélection de sneakers, des modèles classiques aux modèles les plus exclusifs. Vous trouverez sur notre site des sneakers de toutes les marques, telles que Nike, Adidas, Jordan, Converse, Puma, etc."
        ];
