                        ...
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled d-flex justify-content-center mb-1">
                                    <li>
                                        @php
                                        $moyenne = $article->moyenneNote; // Assurez-vous que 'moyenneNote' est une valeur numérique
                                        // Débogage : affichez la moyenne pour voir sa valeur
                                        // echo "Moyenne: " . $moyenne; // Décommenter pour déboguer
                                        $fullStars = floor($moyenne); 
                                        $halfStar = ($moyenne - $fullStars) >= 0.25 ? ($moyenne - $fullStars >= 0.75 ? 1 : 0.5) : 0; // Vérifie s'il faut afficher une demi-étoile
                                        @endphp
