<x-app-layout>
    ...
    if (target) {
        ...
        var pointureElement = cardBody.querySelector('#pointure');
        var pointure = pointureElement ? pointureElement.value : '';
        var quantite = cardBody.querySelector('[name="quantite"]').value;

        console.log('Pointure sélectionnée :', pointure); // Ajoute cette ligne pour vérifier la valeur de la pointure
