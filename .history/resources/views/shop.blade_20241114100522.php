<x-app-layout>
    <section class="py-5 custom-section">
        ...
        <form id="filterForm" class="row gx-2 gy-2 justify-content-center">
            ...
            <div class="col-6 col-sm-4 col-md-2 form-group">
                ...
                <input type="number" id="prix_min" name="prix_min" class="form-control" placeholder="Min" min="0">
            </div>

            <div class="col-6 col-sm-4 col-md-2 form-group">
                <label for="prix_max">Prix Max</label>
                <input type="number" id="prix_max" name="prix_max" class="form-control" placeholder="Max" min="0">
            </div>
...
#filterForm label {
    margin-bottom: 5px; /* Espacement vertical cohérent */
}

@media (max-width: 768px) {
    #filterForm {
        padding: 0 10px; /* Réduction du padding pour s'adapter aux écrans plus petits */
    }
}
