    ...
    <section class="py-5 custom-section">
        ...
        <style>
            ...
            @media (max-width: 768px) {
                #filterForm .form-group {
                    width: 100%;
                    /* Chaque champ prend toute la largeur sur les écrans mobiles */
                    display: flex;
                ...
                #filterForm .form-control {
                    width: 100%;
                    /* Largeur complète pour les champs d'entrée */
                    margin-bottom: 10px;
                    /* Ajoute un espacement entre les champs */
                }

                #filterForm label {
                    margin-bottom: 5px;
                    /* Assure un petit espacement sous les labels */
                }
                ...
                #filterForm button {
                    ...
                    margin: 0;
                    /* Supprime le décalage supplémentaire */
                }
            }

            @media (max-width: 767.98px) { /* Pour les écrans de moins de 768px */
    .card-container {
        display: flex;
