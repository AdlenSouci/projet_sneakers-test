<form id="filterForm" class="container px-4 px-lg-5 mt-5">
            <div class="form-group mt-3">
                <label for="marque">Marque</label>
                <select id="marque" name="marque" class="form-control mt-3" style="width: 200px;">
            ...
            <div class="form-group mt-3">
                ...
                <select id="couleur" name="couleur" class="form-control mt-3" style="width: 200px;">
            ...
            <div class="form-group mt-3">
                ...
                <select id="prix" name="prix" class="form-control mt-3" style="width: 200px;">
        ...
        </form>   j'aimerai modifier le filtre pour le rendre le plus beau possible et ergonomique j'aimerai aussi si possible le mettre a coté sur le coté gauche de la page a coté des articles <x-app-layout>
