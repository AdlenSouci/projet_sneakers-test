<x-app-layout>
    ...
    #filterForm .form-group {
        width: 100%; /* Chaque champ prend toute la largeur sur les écrans mobiles */
        display: flex;
        flex-direction: column; /* Empile les éléments verticalement */
    }

    #filterForm .form-control {
        width: 100%; /* Largeur complète pour les champs d'entrée */
        margin-bottom: 10px; /* Ajoute un espacement entre les champs */
    }

    #filterForm label {
        margin-bottom: 5px; /* Assure un petit espacement sous les labels */
    }

    #filterForm button {
        width: 100%; /* Bouton sur toute la largeur */
        margin: 0; /* Supprime le décalage supplémentaire */
    }
}
