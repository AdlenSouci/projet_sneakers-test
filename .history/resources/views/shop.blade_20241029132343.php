                ...
                success: function(response) {
                    ...
                    $.each(response.articles, function(index, article) {
                        html += `<div class="col mb-5">
                                    <div class="card mb-4 product-wap rounded-0">
                                        <img class="card-img rounded-0 img-fluid" src="/img/${article.img}" alt="Product Image" />
                                        <div class="card-body text-center">
                                            <a href="/article/${article.id}" class="h3 text-decoration-none">${article.modele}</a>
                                            <p class="text-center mb-0">$${article.prix_public}</p>
                                        </div>
                                    </div>
                                </div>`;
