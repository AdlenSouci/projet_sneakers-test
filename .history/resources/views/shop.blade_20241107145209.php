    ...
    <section class="py-5 custom-section">
        ...
        <form id="filterForm" class="d-flex flex-wrap align-items-center">
            <div class="form-group mr-2">
                <label for="marque" class="mr-1">Marque</label>
                <select id="marque" name="marque" class="form-control w-auto" style="width: 100px;">
            ...
            <div class="form-group mr-2">
                <label for="couleur" class="mr-1">Couleur</label>
                <select id="couleur" name="couleur" class="form-control w-auto" style="width: 100px;">
            ...
            <button type="submit" class="btn bg">Filtrer</button>
        </form>
