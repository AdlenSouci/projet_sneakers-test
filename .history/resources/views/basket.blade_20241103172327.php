                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-15">
                                        <div class="p-4">
                                            ...
                                            <div class="row mb-4 d-flex justify-content-between align-items-center" style="background-color: {{ $index % 2 == 0 ? '#ffffff' : '#de7105' }}; padding: 15px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1); transition: transform 0.2s ease;">
                                                ...
                                                <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                    <h6 class="text-black mb-0 item-price" data-item-price="{{ $item['price'] }}">
                                                        € {{ number_format($item['price'] * $item['quantity'], 2) }}
                                                    </h6>
                                                </div>
                                                <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                                    <input type="number" value="{{ $item['quantity'] }}" class="form-control rounded input-quantity" min="1" onchange="changerQuantiter(this)" data-item-price="{{ $item['price'] }}" data-item-id="{{ $item['id'] }}" style="width: 80px; transition: all 0.3s ease;">
                                                </div>
                                                <div class="col-md-1 col-lg-1 col-xl-1 text-end">
