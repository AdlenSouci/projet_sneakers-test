<x-app-layout>
    <section class="py-5 custom-section">
        ...
        <form id="filterForm" class="d-flex flex-wrap justify-content-center align-items-center">
            <div class="form-group mr-2 col-md-4 col-sm-6 col-xs-12">
                <label for="marque" class="mr-2">Marque</label>
                <select id="marque" name="marque" class="form-control" style="width: 100%;">
            ...
            <div class="form-group mr-2 col-md-4 col-sm-6 col-xs-12">
                ...
                <select id="couleur" name="couleur" class="form-control" style="width: 100%;">
            ...
            <div class="form-group mr-2 col-md-4 col-sm-6 col-xs-12">
                ...
                <select id="prix" name="prix" class="form-control" style="width: 100%;">
            ...
            <div class="form-group mr-2 col-md-4 col-sm-6 col-xs-12">
                ...
                <input type="number" id="prix_min" name="prix_min" class="form-control" style="width: 100%;" placeholder="Min" min="0">
            </div>

            <div class="form-group mr-2 col-md-4 col-sm-6 col-xs-12">
                <label for="prix_max" class="mr-2">Prix Max</label>
                <input type="number" id="prix_max" name="prix_max" class="form-control" style="width: 100%;" placeholder="Max" min="0">
            </div>
