                                            ...
                                            <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                                                    <div class="d-flex mb-4" style="max-width: 300px">
                                                        <button class="btn btn-primary px-3 me-2" data-item-id="{{ $item['id'] }}" onclick="changerQuantiter(this, -1)">
                                                            <i class="fas fa-minus"></i>
                                                        </button>


                                                        <div class="form-outline">
                                                            <input id="form1" min="1" name="quantity" value="{{ $item['quantity'] }}" type="number" class="form-control" data-item-id="{{ $item['id'] }}" onchange="changerQuantiter(this, 0)" />
                                                        </div>

                                                        <button class="btn btn-primary px-3 ms-2" data-item-id="{{ $item['id'] }}" onclick="changerQuantiter(this, 1)">
