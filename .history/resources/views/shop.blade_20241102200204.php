    ...
    <script>
        ...
        $(document).ready(function() {
            $('#filterForm').on('submit', function(e) {
                ...
                const selectedFamille = $('#famille').val();
                const selectedCouleur = $('#couleur').val();

                $('.row-cols-xl-4 .col').each(function() {
                    const articleMarque = $(this).data('marque');
                    const articleFamille = $(this).data('famille');
                    const articleCouleur = $(this).data('couleur');

                    if (selectedMarque === "" || articleMarque === selectedMarque || selectedFamille === "" || articleFamille === selectedFamille || selectedCouleur === "" || articleCouleur === selectedCouleur) {
        ...
        $(document).ready(function() {
            $('#filterForm').on('submit', function(e) {
                ...
                $('.row-cols-xl-4 .col').each(function() {
                    ...
                    if (selectedFamille === "" || articleFamille === selectedFamille) {
                        if (selectedCouleur === "" || articleCouleur === selectedCouleur) {
                            $(this).show(); // Affiche l'article
                        } else {
                            $(this).hide(); // Masque l'article
                        }
