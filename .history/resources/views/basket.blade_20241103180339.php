                            ...
                            <div class="card-body p-0">
                                <div class="row g-0">
                                    ...
                                    <div class="col mb-5 text-center p-5">
                                        ...
                                        <div class="text-center text-white" style="margin: 50px 0;">Votre panier est vide</div>
                                    ...
                                    <div class="col-lg-15">
                                        <div class="p-4 rounded-3" style="background-color: #000000;">
                                            <div class="d-flex justify-content-between align-items-center mb-4">
                                                ...
                                                <h6 class="text-muted text-white">{{ count($cartItems) }} articles</h6>
                                            </div>
                                            <hr class="my-3">
                                            ...
                                            @else
                                            <p class="text-center texte  mt-3">Connectez-vous pour passer une commande.</p>
                                            @endif
                                        </div>
                                    </div>
                                    @endif
