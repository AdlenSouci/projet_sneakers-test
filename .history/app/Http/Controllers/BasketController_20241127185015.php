...
class BasketController extends Controller
{
    ...
    public function passerCommande(Request $request)
    {
        ...
        $message = "Une nouvelle commande a été passée par le client: $userName ($userId)\n";
        ...
        Mail::send('emails.nouvelle_commande', ['client' => $userName, 'total' => $total_ttc], function ($message) use ($userName) {
