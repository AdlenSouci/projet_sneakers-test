            ...
            <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-md-2 row-cols-xl-4 justify-content-center g-3">
                ...
                <div class="col mb-5 custom-col">
                    <div class="card h-100 custom-card">
                        <img class="card-img-top custom-card-img-top" src="{{ asset('img/' . $article['img']) }}"
                            alt="Product Image" />
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent custom-card-footer">
                            <div class="text-center custom-text-center">
                                ...
                                <br>
                                <a class="btn btn-outline-dark mt-auto toggleDescription custom-a"
                                    href="{{ route('article', $article['id']) }}">Voir plus</a>
                                <br><br>
                                ...
                                @if($stock_article > 0)
                                    <button class="btn btn-outline-dark mt-auto ajouter_au_panier custom-button"
                                        data-article-id="{{ $article['id'] }}" style="margin-left: 10px">Ajouter au
                                        panier</button>
                                @endif
                            </div>
                        </div>
