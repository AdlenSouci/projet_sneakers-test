                                            ...
                                            <div class="p-10">
                                                <div class="d-flex justify-content-between align-items-center mb-5">
                                                    <h6 class="mb-0"><a href="/shop" class="text-body"><i
                                                                class="fas fa-long-arrow-alt-left me-2"></i>Retour à la
                                                            boutique</a>
                                                    </h6>
                                                    <h1 class="fw-bold mb-0 text-black">Panier</h1>
                                                </div>
                                                <div
                                                    style="margin: 50 0; display: flex; align-items: center; justify-content: center;">
                                            ...
                                            <div class="p-10">
                                                ...
                                                @foreach ($cartItems as $item)
                                                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-1 col-lg-1 col-xl-1 text-end"  onclick="viderArticlePanier(this)"
                                                ...
                                                <div class="p-5">
                                                    ...
                                                    @if(auth()->check())
                                                        <form action="" method="post"
                                                            onsubmit="event.preventDefault(); expedierCommande()">
                                                            @csrf
                                                            <input type="text" class="form-control" name="adresse_livraison"
                                                                id="adresse_livraison" placeholder="Adresse de livraison"
                                                                required>
                                                            <br>
                                                            <button type="submit" id="passCommandButton"
                                                                class="btn btn-dark btn-block btn-lg">Passer la
                                                                commande</button>
                                                        </form>
